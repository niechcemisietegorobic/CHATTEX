...
<template>
    <section id="app-section" >
        ...
        <nav class="tabs">
            <button class="tab active" data-tab="public" @click="active_chat = 'public'">Publiczny czat</button>
            <button class="tab" data-tab="private" @click="active_chat = 'private'">Prywatne</button>
            <button class="tab" data-tab="forum" @click="active_chat = 'forum'">Forum</button>
        </nav>
